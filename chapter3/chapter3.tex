...
compare to nerusheva model
    bub1 localisation
    substrate 
    phosphatase
compare to human model
    different 
    but key supported by hints
    might actually be unifying
drawbacks of the model
    Sgo1 on chromatin can't see by ChIP but overexpression in Clift 2009 is a good sign
    couldn't find the phosphatase
    phosphatase inhibitors drama
...
strengthen weaknesses
    H2A-pS121 western in glc7 mutants
    repeat ChIP-seq in other species
