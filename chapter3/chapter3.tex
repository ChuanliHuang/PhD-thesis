...
\begin{figure}[htbp]
  ...
  \caption[Sgo1 is not de-localised from peri-centromere in \textit{glc7-10} at restrictive temperature]{Sgo1 is not de-localised from peri-centromere in \textit{glc7-10} at restrictive temperature. Schematics of the experimental procedure. Cells bearing \textit{pMET-CDC20} were synchronised in G1 using $\alpha$ factor and released into methionine-containing media for a metaphase arrest with tension. Cells were shifted to 37 \si{\celsius} from the time of the G1 release and time-lapse live-cell imaging was also started. (B) Montages of representative time-lapse imaging.}
