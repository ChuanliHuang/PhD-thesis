...
\begin{figure}[htbp]
  ...
  \caption[The shorter distance between Bub1 and peri-centromere is independent of the inter-kinetochore distance]{The shorter distance between Bub1 and peri-centromere is independent of the inter-kinetochore distance (Continued on the following page). }
  \label{fig:periCEN}
\end{figure} 

\begin{figure}[htbp]
    \centering
    \contcaption {The shorter distance between Bub1 and peri-centromere is independent of the inter-kinetochore distance. (A) Schematics of experimental procedures. Cells bearing \textit{pMET-CDC20} were synchronised in G1 using $\alpha$ factor and released into methionine-containing media for a metaphase arrest with tension. Time-lapse live-cell imaging was performed from the time of the G1 release. (B) Montage of representative time-lapse imaging. (C) Scatter plot showing the relation of Bub1-to-peri-centromere distance and inter-kinetochore distance. N=30 cells were followed over time and quantified for $L$ (the distance before Bub1-mNG separation), $L_{1}$ (the shorter distance after Bub1-mNG separation) and $L_{2}$ (the longer distance after Bub1-mNG separation), which are presented in green, orange and blue, respectively. The line with the same colour represents the model of simple linear regression. }
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption[Total cellular H2A-pS121 level is independent of tension]{Total cellular H2A-pS121 level is independent of tension. (A) Schematics of experimental procedures. Cells were synchronised in G1 by $\alpha$ factor and then released into methionine- or nocodazole-containing media for a metaphase arrest with or without tension. Methionine or nocodazole was re-added at 1 \si{\hour} after the release to ensure arrest. Samples were collected at 2 \si{\hour}. A representative experiment of two repeats is shown. (B) Western blotting with anti-H2A-pS121 antibody to detect the phosphorylation status of H2A. Pgk1 was used as the loading control. The asterisk represents the non-specific band.}
...
\begin{figure}[htbp]
  ...
  \caption[H2A-pS121 is re-distributed from centromere to chromosome arm upon the establishment of tension]{H2A-pS121 is re-distributed from centromere to chromosome arm upon the establishment of tension (Continued on the following page). }
  \label{fig:ph2achipse}
\end{figure}

\begin{figure}[htbp]
    \centering
    \contcaption{H2A-pS121 is re-distributed from centromere to chromosome arm upon the establishment of tension. (A) Calibrated H2A-pS121 ChIP-seq profiles of cells arrested in metaphase with or without tension and their difference (tension - no tension) at the 50kb region around the centromere of chromosome IV (upper left), a 50kb region on the left arm of chromosome IV (upper right) and the entire chromosome IV (bottom left). The overlapped profiles are shown in the bottom right. (B) Pile-up of centromeres and chromosome arms. Left: the 50kb regions around the centromeres of all 16 chromosomes. Right: the 50kb regions around chromosome arms (80kb left to the centromere) of all 16 chromosomes. (C) The number of sequencing reads assigned to centromeres (the 50kb-region flanking the core centromere) or chromosome arms in each sample. }
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption[Sgo1 association with chromatin remains low regardless of tension in H2A phospho-mimic mutant]{Sgo1 association with chromatin remains low regardless of tension in H2A phospho-mimic mutant (Continued on the following page).}
  \label{fig:sgo1chiph2amutants}
\end{figure}

\begin{figure}[htbp]
    \centering
    \contcaption{Sgo1 association with chromatin remains low regardless of tension in H2A phospho-mimic mutant. (A) Schematics of experimental procedures. Cells were synchronised in G1 by $\alpha$ factor and then released into methionine- or nocodazole-containing media for a metaphase arrest with or without tension. Methionine or nocodazole was re-added at 1 \si{\hour} after the release to ensure arrest. Samples were collected at 2 \si{\hour}. Three repeats were performed for the experiment. (B) Spindle morphology count by tubulin IF. (C) Western blotting with anti-HA antibody to detect the expression level of Sgo1-6HA. Pgk1 was used as the loading control. (D) Schematics showing the locations of loci used for the ChIP-qPCR experiment. (E) Sgo1-6HA ChIP-qPCR on the chromosome arm, the peri-centromere and the core centromere of chromosome IV. The mean of three repeats is shown, with the error bar representing the standard error. The two-tailed independent t-test is used to calculate statistical significance. (*) P<0.05; (ns) not significant.}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption[Sgo1 is not de-localised from peri-centromere in \textit{glc7-10} at restrictive temperature]{Sgo1 is not de-localised from peri-centromere in \textit{glc7-10} at restrictive temperature. Schematics of experimental procedures. Cells bearing \textit{pMET-CDC20} were synchronised in G1 using $\alpha$ factor and released into methionine-containing media for a metaphase arrest with tension. Cells were shifted to 37 \si{\celsius} and time-lapse live-cell imaging was performed from the time of the G1 release. (B) Montages of representative time-lapse imaging.}
...
\begin{figure}[htbp]
  ...
  \caption[PP2A-Rts1 is required for timely sister kinetochore separation but not for reducing Sgo1 level at peri-centromere]{PP2A-Rts1 is required for timely sister kinetochore separation but not for reducing Sgo1 level at peri-centromere. PP2A-Rts1 is required for timely sister kinetochore separation but not for reducing Sgo1 level at peri-centromere. (A) Schematics of the imaging experiment. Cells bearing \textit{pMET-CDC20} were synchronised in G1 using $\alpha$ factor and released into methionine-containing media for a metaphase arrest with tension. Time-lapse live-cell imaging was performed from the time of the G1 release. (B) Montages of representative time-lapse imaging. (C) N=30 cells for each strain were followed over time and quantified. Top panel: the percentage of cells with Sgo1-EGFP foci was shown as a function of time. Bottom panel: median inter-kinetochore distance as a function of time. Individual data points are shown as dots. (D) N=10 cells for the wild type and \textit{rts1$\Delta$} were quantified for the highest fluorescence intensities of Sgo1-EGFP foci among all frames. The two-tailed independent t-test was used to calculate statistical significance. (ns) not significant. }
  \label{fig:sgo1rts1mutants}
\end{figure}

% \begin{figure}[htbp]
%     \centering
%     \contcaption{PP2A-Rts1 is required for timely sister kinetochore separation but not for reducing Sgo1 level at peri-centromere. (A) Schematics of the imaging experiment. Cells bearing \textit{pMET-CDC20} were synchronised in G1 using $\alpha$ factor and released into methionine-containing media for a metaphase arrest with tension. Time-lapse live-cell imaging was performed from the time of the G1 release. (B) Montages of representative time-lapse imaging. (C) N=30 cells for each strain were followed over time and quantified. Top panel: the percentage of cells with Sgo1-EGFP foci was shown as a function of time. Bottom panel: median inter-kinetochore distance as a function of time. Individual data points are shown as dots. (D) N=10 cells for the wild type and \textit{rts1$\Delta$} were quantified for the highest fluorescence intensities of Sgo1-EGFP foci among all frames. The two-tailed independent t-test was used to calculate statistical significance. (ns) not significant.}
% \end{figure}
