...
\underline{Primary antibody}\\
1 \si{\milli\gram/\milli\litre} Rat $\alpha$-tubulin\\

\underline{Secondary antibody}\\
1.25 \si{\milli\gram/\milli\litre} Donkey $\alpha$-rat-FITC\\
...
\textbf{Reagent}        & \textbf{Volume} \\ \hline
DNA (1-20ng)            &                 \\
10X   blunting buffer   & 5 \si{\micro\litre}            \\
...
10X   NEB buffer 2       & 3.3 \si{\micro\litre}          \\
...
\label{rab:AdapterLigation}
\begin{tabular}{ll}
\hline
\textbf{Reagent}             & \textbf{Volume} \\ \hline
DNA                          & 33 \si{\micro\litre}           \\
2X Quick DNA ligation buffer & 35 \si{\micro\litre}           \\
