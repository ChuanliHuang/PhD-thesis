...
And the state-transition function becomes:
...
To verify the mean-field analysis, I wanted to simulate the model. In the first attempt, 
Note that $rr$ higher than the basic had to be used to generate the non-zero steady state. 
